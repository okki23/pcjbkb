...
<div class="row">
<div class="col-md-12"> 
<form action="<?php echo base_url('home_backend/save') ;?>" method="POST">
		<div class="col-md-12">
				...
				<div  align="center">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('home_backend'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
                </div>
				<br>
				<br>
				<br>				 
